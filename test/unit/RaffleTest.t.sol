...
contract RaffleTest is CodeConstants, Test {
    ...
    function test_RaffleRevertsWhenUserDoesNotPayEnough() public {
        // Arrange
        vm.prank(PLAYER);
        // Act/Assert
    ...
    function test_checkUpkeepReturnsTrueIfParametersAreGood() public {
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
    ...
    function test_performUpkeepRevertsIfCheckUpkeepIsFalse() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Raffle.Raflfle__UpkeepNotNeeded.selector,
                currentBalance,
                numPlayers,
                rState
            )
